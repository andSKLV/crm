...
class ContractMaker {
    ...
    confConstructor(mf) {
        ...
        conf.vars = {
            ...
            p7_5: 'В случае изменения количества транспортных средств Страховщик производит перерасчет страховой премии с применением Программы расчета страховой премии, использовавшейся при заключении Договора.',
            p7_5_1: 'Перерасчет страховой премии при исключении транспортных средств из Перечня (в том числе - путем замены) допускается при условии подтверждения Страхователем факта отчуждения или утраты (гибели) исключаемого  транспортного средства. В иных случаях уменьшение количества транспортных средств не влечет перерасчета страховой премии. ',
            p7_5_2: 'Перерасчет страховой премии при исключении транспортных средств, вовлеченных в страховой случай, подпадающий под действие настоящего Договора, не производится. ',
            p7_5_3: 'В случае изменения государственных регистрационных номеров одних и тех же транспортных средств  перерасчет страховой премии не производится.',
            p7_6: 'Результаты изменения Перечня транспортных средств отражаются в Дополнительном соглашении к Договору, подписываемому Сторонами.',
            p7_7: 'Страхование, предусмотренное Договором, распространяется только на перевозки, осуществляемые транспортными средствами, указанными в этом Дополнительном соглашении, со дня, следующего за датой его подписания, если Сторонами не будет согласовано иное.',
