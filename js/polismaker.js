...
class ContractMaker {
    ...
    confConstructor(mf) {
        ...
        conf.vars = {
            ...
            p7: 'УЧЁТ УБЫТОЧНОСТИ',
            p7_1: 'Уровень убыточности по Договору определяется как отношение выплаченного страхового возмещения к сумме полной (годовой) страховой премии на дату определения убыточности, переведенное в проценты.',
            p7_2: 'При превышении уровнем убыточности указанных ниже значений производится перерасчет страховой премии по Договору:',
            p7_3: 'Сумма дополнительной страховой премии подлежит оплате равными долями до конца срока действия Договора согласно графику уплаты страховой премии или в ином порядке, согласованном Сторонами. Если страховая выплата, повлекшая увеличение убыточности, осуществляется после окончания Договора или его досрочного прекращения, оплата дополнительной страховой премии производится Страхователем в течение 5-ти банковских дней с момента получения счета Страховщика, если иное не будет согласовано Сторонами.',
            p7_4: 'В последующие годы страхования сумма выплаченного страхового возмещения и сумма оплаченной страховой премии учитываются Страховщиком при расчетах нарастающим итогом с даты начала непрерывного периода страхования.',
            p8: 'УВЕДОМЛЕНИЕ СТРАХОВЩИКА О НАСТУПЛЕНИИ СТРАХОВОГО СЛУЧАЯ',
            p8_1: 'При наступлении страхового случая Страхователь обязан незамедлительно, с применением любых доступных средств связи, уведомить об этом Страховщика. Письменное уведомление (Приложение №4 к Договору) должно быть направлено Страховщику не позднее 3-х рабочих дней с момента, когда Страхователь узнал или должен был узнать о случившемся. ',
            p8_2: 'Неисполнение Страхователем обязанности по уведомлению дает Страховщику право отказать в выплате страхового возмещения, если не будет доказано, что Страховщик своевременно узнал о наступлении страхового случая либо что отсутствие у Страховщика сведений об этом не могло сказаться на его обязанности выплатить страховое возмещение. Указанные последствия могут быть применены, в частности, если отсутствие своевременного уведомления не позволило Страховщику реализовать право на проверку факта наступления события или на участие в оценке суммы ущерба.',
            p9: 'ЗАКЛЮЧИТЕЛЬНЫЕ ПОЛОЖЕНИЯ',
            p9_1: 'Договор заключен на основании Правил страхования грузов для транспортных операторов ООО «СК «Капитал-полис», являющихся неотъемлемым приложением к настоящему Договору (Приложение №6). В случае расхождений между положениями Договора и положениями Правил преимущественную силу имеют положения настоящего Договора. В соответствии с Законом РФ от 27.11.1992 N 4015-1 "Об организации страхового дела в Российской Федерации" Правила размещены в информационно-телекоммуникационной сети "Интернет" на официальном сайте Страховщика по адресу: http://capitalpolis.ru/upload/cargo/HIP_pravila_20150220.pdf. Стороны подтверждают, что ими изучено содержание и им понятно толкование  всех условий и терминов Договора и Правил.   ',
            p9_2: 'Все расчеты страховой премии по настоящему Договору осуществляются с применением Программы расчета страховой премии (Свидетельство о государственной регистрации №2004612468).',
            p9_3: 'Стороны обязуются сохранять конфиденциальность страховых операций, а также других сведений, полученных в процессе выполнения обязанностей по  Договору.',
            p9_4: 'Договор составлен в двух экземплярах на русском языке, имеющих одинаковую юридическую силу, по одному для каждой стороны.',
            p9_5: 'Все изменения по  Договору исполняются только в письменном виде по обоюдному согласию сторон за подписью уполномоченных лиц и за печатями обеих сторон.',
            p9_6: 'Стороны определили, что копии документов, переданные посредством электронной связи, имеют юридическую силу до момента замены их на оригиналы. Обмен оригиналами осуществляется Сторонами не реже одного раза в месяц.',
            p9_7: 'Неотъемлемыми приложениями к настоящему Договору являются:',
            p9_7_1: 'Заявление на страхование;',
            p9_7_2: 'Полис CMR/ТТН - страхования;',
            p9_7_3: 'Перечень транспортных средств Страхователя;',
            p9_7_4: 'Уведомление о произошедшем убытке;',
            p9_7_5: 'Заявление (Дополнительное соглашение) на увеличение лимита ответственности по страховому случаю по одной грузовой отправке (форма);',
            p9_7_6: 'Правила страхования грузов для транспортных операторов ООО «СК  «Капитал-полис», утвержденные Приказом от 20.02.2015 № 10-Д.',
            p9_7_end: 'Страхователь со всеми вышеуказанными приложениями ознакомлен и согласен, все приложения получил.',
