...
Изменения 07.11.2018:
 ...
 + Полис: при загрузке из редактора (расчет, компания и тд) открывается отредактированная вкладка
 + Расчет: исправлена ошибка, которая проявлялась при создании строки с уже существующим риском
 + Сохранение расчета: при открытии меню сохранения уже сохраненного расчета к названию добавляется текущее время (на случай сохранения нового варианта расчета без удаления старого)
