...
Изменения 17.09.2018:
 + Добавлена возможность иметь несколько типом матриц и переключаться между с помощью кнопки выбора. Кнопка исчезает если в матрице есть хоть одна строчка.
