...
Изменения 26.07.2018:
 + Переписана функция копирования параметров по нажатию кнопки вниз
 + Добавлена возможность копирования мульти-параметров вниз
 + Исправлено: если при копировании мульти-отсека внизу находится мульти узел, то его структура будет нарушена, что приведет к неправельному подсчету премии и в дальнейшем к ошибке во взаимодействии
