...
Изменения 12.02.2019:
 + Переименовывания, удаление, изменение очередности, добавление новых элементов.
 + Базовый риск нельзя удалить
 + В углублении и пакете не может оставаться меньше двух элементов.
 + При переименовывании и удалении рисков, они автоматически удаляются из пакетов, которые их содержат. Если в процессе удаления рисков пакет оказывается пустым - он удаляется автоматически.
 + 