...
Изменения 17.10.2018:
 ...
 + Меню сохранения расчета изменено. 
    Для сохранения расчета в подменю "сохранить" после ввода названия нажать enter. 
    Для перезаписи загружженного расчета в подменю "сохранить" необходимо не изменяя название нажать enter. 
    Для сохаренния загруженного расчета под другим названием необходимо изменить название и нажать enter.
    Для замены старого расчета на созданный в подменю "сохранить"->"заменить другой расчет" ввести название расчета в поиск и выбрать расчет из предложенных вариантов.
