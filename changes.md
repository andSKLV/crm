...
Изменения 02.11.2018:
 ...
 + Полис:
    ...
    -Даты:
        ...
        Добавлена возможность выбрать срок: 1 год (по умолчанию), 6 месяцев
    -Финансы:
...
Изменения 18.02.2019:
 + Возможность выбора каретки для редактирования.
 + Создание новой каретки из шаблона.
 + При сохранении новой каретки или изменении старой запрашивается имя, под которым будет сохранена каретка. Если имя оставить прежним, то каретка просто обновится, при изменении имени будет создана новая каретка.
 + Выбор в расчете новых созданных кареток.
 + Доступ в редактор каретки из расчета, по нажатию на шестеренку в правмо верхнем углу.
 + Пароль на вход в редактор кареток (1234, нужно решить на какой сменить)
 + Окончание ввода в ячейку по нажатию на enter

Изменения 21.02.2019:
 + Возможность удалить лимит и франшизу из каретки
 + При удалении лимита или франшизы они никак больше не влияют на расчетную стоимость, таким образом при удалении лимитов отключается агрегатный лимит и кол-во случаев.